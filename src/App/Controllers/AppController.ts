import { Color, CornerRadiusTypes, cTop, cTopLeading, cVertical, ForEach, HStack, Icon, IconLibrary, PositionTypes, ScrollView, State, Text, TextField, TForm, UIController, UIImage, UIScene, VStack, ZStack } from '@tuval/forms';
                    ...
                    ...ForEach(this.showingIcons)(icon =>
                        VStack(
                            ...
                            Text(icon.name)
                                ...
                                .width('100%')
                        ).width(112).height(128)/* .backgroundColor('rgb(255,255,255,50%)') */.cornerRadius(CornerRadiusTypes.Medium).marginBottom('10px').cursor("pointer")
                    )
